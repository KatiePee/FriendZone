...
def remove_post(id):
    ...
    post_images_list = [post.post_image.to_dict() for post.post_image in post.post_images]

    [remove_file_from_s3(post_image["imageUrl"]) for post_image in post_images_list]
